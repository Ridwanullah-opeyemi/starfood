...
import signHooks from "../sign/signuphooks/signhooks";


const Nav = () => {
    const { getTotalQuantity, cart } = useContext(Cartcontexts)
    
    const { handleinput, filterpro, cartboxshow, handlecarfbox, searchvisible, handlecartbox, handlelocatspin, locatspin, locationtt, handlelocafionbox, visible, handlelocationbox } = SearchInput()
                    ...
                    <div className="navcon">
                        ...
                        <div className="usercon">
                            <div className="searchCon">
                                ...
                                <input type="text" placeholder="search starfood..." onChange={handleinput} id="searchvalueid" />
                                {
                                    searchvisible ? (
                                        <div className="searchvisible">
                                            <div className="products">
                                                {
                                                    filterpro.map((products, i) => (
                                            ...
                                            <div className="sclose"><button onClick={visible}>close</button></div>
                                        </div>
                                    ) : <></>
                                }
                            </div>
                            ...
                            <div className="cartbox" style={{ width: cartboxshow ? "500px" : "" }}>
                                <nav>
